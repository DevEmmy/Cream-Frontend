  ...
  return (
    <a href={`/real-estate/${listing._id}`}>
        ...
        <div className='flex gap-2 items-center'>
            <img src={listing.postedBy.profilePicture} alt="" className='w-14 h-14 rounded-[50%]'/>
            <p className='font-[600]'>{listing.postedBy.firstName + " " + listing.postedBy.lastName}</p>
        </div>
        <div className='relative'>
            <img src={listing.images[0]} alt="" className='w-full h-[200px] rounded-tl-3xl rounded-br-3xl my-3'/>
        ...
        <p className='text-[0.8em] flex items-center'><HiLocationMarker /> {listing.location}</p>  
