...
function TransferPayment({ planName, planDetails, randomReferenceNumber }) {
  ...
  return (
    <div className="justify-center w-full ">
      <div className=" border  rounded-lg shadow-md shadow-black h-auto w-full sm:px-2 sm:py-4 px-[25%] py-8 bg-white">
        ...
        <div className="">
          <div className="mb-4">Bank Name: GT Bank</div>
          <div className="mb-4">Account Number: 0567154759</div>
          <div className="mb-4">Reference number: {randomReferenceNumber}</div>
          <div className="mb-4">
            Include the reference number in your transfer narration
          </div>
          <div className="">
            Account Number: Emmanuel Oluwasegun Olaosebikan
          </div>
        </div>
      </div>
    </div>
